...
<div class="i_bg">  
    ...
    <div class="content mar_20">
       ...
       @foreach($ods as $kk=>$vv)
        <!--Begin 支付宝支付 Begin -->
        <div class="warning">           
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              <tr height="35">
                <td style="font-size:18px;">
                    感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font color="#ff4e00">{{ $vv->numbers }}</font>
                </td>
              </tr>
              <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">您的应付款金额为: <font color="#ff4e00">￥{{ $vv->xiaoji }}.00</font>
                </td>
              </tr>
    	...
    	<div class="warning">        	
            <table border="0" style="width:1000px; text-align:center;" cellspacing="0" cellpadding="0">
              <tr>
                <td>
                	<p style="font-size:22px;">支付 !</p>
                    <b style="color:#ff4e00; font-size:16px; font-family:'宋体';">应付款:{{ $zong }}</b>
                	<div class="backs"><a href="/home/order/myorder">点击付款</a></div>
                </td>
              </tr>
            </table>        	
        </div>
