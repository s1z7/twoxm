    	...
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
            ...
            @else
                ...
                <tr>
                    ...
                    <td align="center">属性：{{$v->infos->taste}}</td>
                    <td align="center">
                        <a href="/home/car/descnum?id={{ $v->id }}"><button style="background:#fff;border:1px solid #ddd"><img src="/h/images/jian.jpg" style="width:20px"></button></a>
                        <button style="background:#fff;border:1px solid #fff; font-size:20px">{{$v->num}}</button>
                        <a href="/home/car/addnum?id={{$v->id}}"><button style="background:#fff;border:1px solid #ddd"><img src="/h/images/jia.jpg" style="width:20px"></button></a>
                    </td>
                    <td align="center" style="color:#ff4e00;">￥{{$v->price}}.00</td>
                    <td align="center">
                        <button style="background:#eee; border:1px solid #eee; width:80px; height:30px; font-size:14px"><a href="/home/car/delete?id={{ $v->id }}">删除</a></button>
                    </td>
                </tr>
                @endforeach
            @endif
          ...
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="/home/index"><img src="/h/images/buy1.gif" /></a>&nbsp; &nbsp; <a href="/home/order/account"><img src="/h/images/buy2.gif" /></a>
            </td>
          </tr>
        </table>
