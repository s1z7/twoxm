...
<div class="m_top_bg" style="background-color:red;">
    <div class="top">
        <div class="m_logo"><a href="Index.html"><img src="/h/images/logo1.png" /></a></div>
        <div class="m_search">
            <form>
...
<div class="i_bg bg_color">
	...
	<div class="m_content">
   		<div class="m_left">
        	<div class="left_n" style="background-color:red;">个人中心</div>
            <div class="left_m">
            ...
            <div class="left_m">
                ...
                <ul>
                	<li><a href="/home/geren" class="now">用户信息</a></li>
                    <li><a href="/home/geren/editxi/{{session('id')}}">修改信息</a></li>
                </ul>
            </div>
            <div class="left_m">
            	<div class="left_m_t t_bg3">账户中心</div>
                <ul>
                	<li><a href="/home/geren/mima/{{session('id')}}">修改密码</a></li>
                </ul>
            </div>
        </div>
    ...
    <div class="b_btm_bg b_btm_c">
        ...
        <div class="b_nav">
    	<ul>                                                                            @foreach($data_link as $k=>$v)                
        	<li style="float:left;margin-left:40px;font-size:25px;margin-top:20px;"><a href="{{$v->url}}" style="color:green;">{{$v->name}}</a></li>
              @endforeach
        </ul>
        <div class="b_tel_bg">
